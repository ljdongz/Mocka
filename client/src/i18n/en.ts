const en = {
  ...
  media: {
    title: 'Media',
    empty: 'No media registered.',
    addToStart: 'Add a file to start.',
    dropHint: 'Drop files or click',
    ...
    usageHint: "Put {{$media 'name'}} in a Response Body and the mock server replaces it with this file's URL, built from the host the request came in on — so a simulator and a real device on your network each get an address that works.",
  },
  ...
  onboarding: {
    ...
    mediaResponses: 'Media Responses',
    mediaResponsesDesc: "Register a local image, video or file and reference it with {{$media 'name'}}. The mock server serves it and builds the URL from the host the request arrived on, so a simulator and a real device both get an address that resolves.",
    ...
    endpointControlDesc: 'Switch a single endpoint off to make it answer 404 without deleting it, and clear out collections and endpoints together in select-to-delete mode.',
    previewEndpointControl: 'COLLECTIONS',
    previewDisabled: 'Disabled',
    previewSelectedCount: '3 selected',
